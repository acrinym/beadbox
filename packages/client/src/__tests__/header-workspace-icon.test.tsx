...
// and it asks TanStack Query whether the workspace has .beadtrain plans
// (useHasTrains), so it needs a QueryClient too. Retries are off so the
// rpc stub's failure settles at once instead of after the retry back-off.
